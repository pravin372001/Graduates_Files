...
public class MapAB 
{
    ...
    {
        System.out.println(mapAB(new HashMap<String, String>(){{put("a", "Hi"); put("b", "There");}}));
        System.out.println(mapAB(new HashMap<String, String>(){{put("a", "Hi");}}));
        System.out.println(mapAB(new HashMap<String, String>(){{put("b", "There");}}));
    }    
}
